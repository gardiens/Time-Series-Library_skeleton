...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        ----------
        x_enc : Tensor
            Tenseur d'entrée pour l'encodeur
        x_mark_enc : tensor ou np.array
            encodage du temps. pour certains dataset il est étrange. 
            np.array de la même taille que x_enc
        x_dec : Tensor
            sert à rien
        x_mark_dec : tensor
            embedding du temps pour la sortie du transformers? 
        Returns
        -------
        Tensor
